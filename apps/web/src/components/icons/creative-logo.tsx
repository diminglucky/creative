...
/**
 * Creative brand logo — 6-petal blob with star (left) and smile (right).
 *
 ...
 *
 * @example
 * <CreativeLogo className="size-7 text-foreground" />
 */
export function CreativeLogo(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 100 100"
      fill="none"
 ...
 */
export function CreativeLogoInverted(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 100 100"
      fill="none"
