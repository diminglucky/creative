...
import type { ImageGenerationPreference, ProjectSummary, VideoGenerationPreference } from "@creative/shared";
...
import { CreativeLogo } from "@/components/icons/creative-logo";
  ...
  return (
    <div className="flex h-full flex-col items-center overflow-auto px-4 py-8 sm:px-6 md:py-12 lg:py-16">
      ...
      >
        ...
        >
          <CreativeLogo className="size-7 text-foreground md:size-8" />
