...
import type { ImageGenerationPreference, VideoGenerationPreference } from "@creative/shared";
...
export const INITIAL_ATTACHMENTS_KEY = "creative:initial-attachments";
export const INITIAL_IMAGE_GENERATION_PREFERENCE_KEY =
  "creative:initial-image-generation-preference";
export const INITIAL_VIDEO_GENERATION_PREFERENCE_KEY =
  "creative:initial-video-generation-preference";
export const INITIAL_AGENT_MODEL_KEY = "creative:initial-agent-model";
